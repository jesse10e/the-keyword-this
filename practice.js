...
//Answer Provides context for an object in a function

// 2) What are the four rules that govern what the 'this keyword' is bound to and describe each?

//Answer Explicit (apply, bind, call)
//implicit (to the left of the dot)
//default window (calling the outermost object)
//new (creating new object with "this")

// 3) What is the difference between call and apply?

//Answer call is used for individual arguements(use commas). Apply is used for arrays

// 4) What does .bind do?

//Answer ties a function and an object to a variable
